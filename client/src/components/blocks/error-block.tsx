...
export function ErrorBlock({ code, message, createdAt }: ErrorBlockProps) {
  return (
    <div className="rounded-xl border border-red-500/25 bg-red-500/5 p-4 shadow-sm backdrop-blur-sm flex gap-3 animate-in fade-in duration-200 w-full">
      ...
      <div className="space-y-1 select-text">
        ...
        <p className="text-xs text-red-600 dark:text-red-400 font-semibold leading-relaxed font-sans">
          {message}
        </p>
