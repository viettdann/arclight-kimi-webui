...
export function UserBlock({ content, status, createdAt }: UserBlockProps) {
  ...
  return (
    <div className="flex flex-col items-end gap-1.5 w-full animate-in fade-in duration-200">
      <div className="max-w-[85%] rounded-2xl bg-primary px-4 py-2.5 text-sm text-primary-foreground shadow-sm font-medium leading-relaxed whitespace-pre-wrap select-text break-words">
        {content}
      </div>
